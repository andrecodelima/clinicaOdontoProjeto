...
<%@page import="com.clinica.odontosolution.model.Teste"%>
<%@page import="com.clinica.odontosolution.services.TesteServices"%>
<%
	ArrayList<Teste> lista = TesteServices.getAllTestes();
	String line = "";
